  ...
  const faqData = [
    {
      ...
      questions: [
        {
          question: "MBTI 테스트 결과를 어떻게 이해해야 하나요?",
          answer: "MBTI는 성격의 선호도를 알려주는 재미있는 도구입니다! 개인의 성격 경향을 파악하는데 도움이 되지만, 절대적인 기준은 아니에요. 참고 자료로 활용하면서 자신을 더 잘 이해하는 계기로 삼아보세요. 시간이 지나면서 성격이 변할 수 있으니 가끔씩 다시 테스트해보는 것도 재미있어요! 쫄부월드의 테스트는 Myers-Briggs 이론을 바탕으로 친근하게 만들어졌습니다."
        },
        {
          question: "테스트는 몇 분 정도 걸리나요?",
          answer: "각 테스트는 보통 1~3분 정도 소요됩니다. 너무 오래 고민하지 마시고, 직감적으로 답변하시는 것이 더 좋은 결과를 얻을 수 있어요. 테마 테스트(공룡, 고양이)는 스토리가 포함되어 조금 더 길 수 있지만, 재미있게 즐기실 수 있습니다."
        },
        {
        ...
        },
        {
          ...
          answer: "각 테스트는 서로 다른 상황과 맥락에서 성격을 측정하기 때문에 약간의 차이가 있을 수 있습니다. 공룡 테스트는 리더십과 생존 본능을, 고양이 테스트는 일상적인 선호도를 중심으로 분석합니다. 여러 테스트 결과를 종합해서 보시면 더 풍부한 자신의 모습을 파악할 수 있어요."
        }
      ]
    },
    {
    ...
    },
    {
      ...
      questions: [
        ...
        {
          question: "연애 스타일 분석은 어떻게 나오나요?",
          answer: "연애 스타일은 각 MBTI 유형의 일반적인 경향을 바탕으로 재미있게 분석됩니다. 하지만 개인의 연애 경험, 가치관, 성장 배경 등에 따라 실제와 다를 수 있어요. 자신과 상대방을 이해하는 하나의 재미있는 관점으로 활용하시고, 실제 관계에서는 충분한 소통이 가장 중요합니다."
        }
      ]
    },
    {
      ...
      questions: [
        ...
        },
        {
          ...
          answer: "브라우저 설정에서 다운로드 허용이 되어있는지 확인해주세요. 모바일의 경우 이미지를 길게 터치해서 저장할 수 있습니다. 또는 스크린샷을 찍어서 저장하는 방법도 있습니다."
        },
        {
    ...
    },
    {
      ...
      questions: [
        ...
        {
          question: "테스트 결과는 어떻게 만들어지나요?",
          answer: "쫄부월드의 모든 테스트는 심리학 이론과 MBTI 기본 원리를 바탕으로 재미있게 제작됩니다. Myers-Briggs Type Indicator의 이론을 기반으로 하되, 더 친근하고 접근하기 쉽도록 각색하여 누구나 즐길 수 있게 만들었어요."
        },
        {
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="bg-gradient-to-r from-purple-100 to-pink-100 rounded-3xl p-8 text-center">
            ...
            <div className="flex flex-wrap justify-center gap-4">
              ...
              <a 
                href="/mbti-guide" 
                className="bg-gradient-to-r from-blue-500 to-indigo-500 text-white px-6 py-3 rounded-xl font-semibold hover:from-blue-600 hover:to-indigo-600 transition-all"
              >
                📚 MBTI 가이드
              </a>
              <a 
